/** Code-listing 8-12
    The Grader class calculates the average of an array of test scores, with
...
public class Grader
{
  ...
  */
  ...
  {
    // Assing the array argument to the testScores field
  ...
  */
  public double getLowestScore()
  {
    ...
    // Step through the rest of the array. When a value less than lowest is
    // found, assign it to lowest.
  ...
  */
  public double getAverage()
  {
    ...
    // if the array contains less than two test socres, disply an error mesg
    // and set average to 0.
