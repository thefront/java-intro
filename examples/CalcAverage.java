...
/** Code-listing 8-13
    This program gets a set of test scores and uses the Grader class
    to calculate the average with the lowest score dropped.
*/
public class CalcAverage
{
  public static void main(String[] args)
  {
    ...
    System.out.println("Youre lowest test score was " + myGrader.getLowestScore());
  }
}